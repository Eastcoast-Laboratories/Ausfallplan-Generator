 ...
 */
$this->assign('title', __('Datenschutzerklärung'));
?>

<div class="datenschutz content">
    <h2><?= __('Datenschutzerklärung') ?></h2>
    
    <h3><?= __('1. Datenschutz auf einen Blick') ?></h3>
    
    <h4><?= __('Allgemeine Hinweise') ?></h4>
    <p>
    ...
    <h4><?= __('Datenerfassung auf dieser Website') ?></h4>
    <p><strong><?= __('Wer ist verantwortlich für die Datenerfassung auf dieser Website?') ?></strong></p>
    <p>
        Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem 
        Abschnitt „Impressum" dieser Website entnehmen.
    </p>
    
    <p><strong><?= __('Wie erfassen wir Ihre Daten?') ?></strong></p>
    <p>
        Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z.B. um Daten handeln, 
        die Sie in ein Kontaktformular eingeben oder bei der Registrierung angeben.
    </p>
    <p>
    ...
    <p><strong><?= __('Wofür nutzen wir Ihre Daten?') ?></strong></p>
    <p>
        Die Daten werden erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Weitere Daten werden zur 
        Verwaltung von Ausfallplänen und Kinderbetreuungseinrichtungen verwendet.
    </p>
    
    <p><strong><?= __('Welche Rechte haben Sie bezüglich Ihrer Daten?') ?></strong></p>
    <p>
    ...
    <h3><?= __('2. Hosting') ?></h3>
    <p>
        Wir hosten die Inhalte unserer Website bei unserem eigenen Server. Dabei werden alle Daten, die Sie auf unserer 
        Website eingeben oder über diese übermitteln, auf diesem Server gespeichert.
    </p>
    
    <h3><?= __('3. Allgemeine Hinweise und Pflichtinformationen') ?></h3>
    
    <h4><?= __('Datenschutz') ?></h4>
    <p>
    ...
    <h4><?= __('Hinweis zur verantwortlichen Stelle') ?></h4>
    <p>
    ...
    <h4><?= __('Widerruf Ihrer Einwilligung zur Datenverarbeitung') ?></h4>
    <p>
    ...
    <h4><?= __('Auskunft, Löschung und Berichtigung') ?></h4>
    <p>
    ...
    <h3><?= __('4. Datenerfassung auf dieser Website') ?></h3>
    
    <h4><?= __('Cookies') ?></h4>
    <p>
        Unsere Internetseiten verwenden Cookies. Cookies sind kleine Textdateien, die auf Ihrem Endgerät gespeichert werden 
        und die Ihr Browser speichert. Sie richten auf Ihrem Endgerät keinen Schaden an und enthalten keine Viren.
    </p>
    <p>
        Cookies dienen dazu, unser Angebot nutzerfreundlicher zu machen. Einige Cookies bleiben auf Ihrem Endgerät gespeichert, 
    ...
    <p>
        ...
        Einzelfall erlauben. Bei der Deaktivierung von Cookies kann die Funktionalität dieser Website eingeschränkt sein.
    </p>
    
    <h4><?= __('Server-Log-Dateien') ?></h4>
    <p>
    ...
    <h4><?= __('Registrierung auf dieser Website') ?></h4>
    <p>
        Sie können sich auf dieser Website registrieren, um zusätzliche Funktionen zu nutzen. Die dazu eingegebenen Daten 
        verwenden wir nur zum Zwecke der Nutzung des jeweiligen Angebotes oder Dienstes, für den Sie sich registriert haben. 
        Die bei der Registrierung abgefragten Pflichtangaben müssen vollständig angegeben werden. Anderenfalls werden wir die 
    ...
    <h4><?= __('Verarbeitung von Daten (Kunden- und Vertragsdaten)') ?></h4>
    <p>
        Wir erheben, verarbeiten und nutzen personenbezogene Daten nur, soweit sie für die Begründung, inhaltliche Ausgestaltung 
        oder Änderung des Rechtsverhältnisses erforderlich sind (Bestandsdaten). Dies erfolgt auf Grundlage von Art. 6 Abs. 1 
        lit. b DSGVO. Personenbezogene Daten über die Inanspruchnahme dieser Website (Nutzungsdaten) erheben, verarbeiten und 
        nutzen wir nur, soweit dies erforderlich ist, um dem Nutzer die Inanspruchnahme des Dienstes zu ermöglichen oder 
        abzurechnen.
    </p>
    
    <p><em><?= __('Quelle:') ?> <a href="https://www.e-recht24.de" target="_blank" rel="noopener">e-recht24.de</a></em></p>
</div>
