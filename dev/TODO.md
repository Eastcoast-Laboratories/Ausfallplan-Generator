...
- [x] die navigation muss einen logout button oben rechts anzeigen, wenn man eingeloggt ist und den usernamen in einem kreis
- [x] eine möglichkeit seine email und sein passwort zu öndern
- [x] die navigation links einbauen mit wenn kleiner als 600px als hamburger umschalten
