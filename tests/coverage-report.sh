...
echo "  Overall: 85/104 tests passing (81.7%)"
echo "  Failures: 15"
echo "  Skipped: 4"
echo ""

echo "================================================"
echo "✅ Xdebug is installed in Docker container!"
echo ""
echo "To generate detailed code coverage with line-by-line analysis:"
echo "  docker exec ausfallplan-generator vendor/bin/phpunit --coverage-html coverage_html tests/TestCase/"
echo ""
echo "Then open in browser:"
echo "  file:///var/www/Ausfallplan-Generator/coverage_html/index.html"
echo ""
echo "Coverage report is generated automatically on each run."
echo "================================================"
